...
import { CREDITS_PER_COMPANY } from '@/lib/billing/config'
    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
        <div className="px-6 pt-6 pb-4">
          ...
          <h2 className="text-lg font-bold text-slate-900 mb-1">Passer a l&apos;etape suivante</h2>
          <p className="text-sm text-slate-500 leading-relaxed">
            Choisissez combien d&apos;entreprises vous souhaitez contacter.
            Chaque entreprise coute <span className="font-semibold text-slate-700">{CREDITS_PER_COMPANY} credits</span>.
          </p>
        </div>
        ...
        <div className="mx-6 mb-6 p-4 bg-slate-900 rounded-xl flex items-center justify-between">
          <span className="text-sm text-slate-300 font-medium">Credits necessaires</span>
