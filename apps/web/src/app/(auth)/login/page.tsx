  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md bg-white rounded-2xl shadow-2xl shadow-black/10 p-8">
        <div className="mb-6">
          <h1 className="text-xl font-bold text-slate-900">Connectez-vous à votre compte</h1>
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2.5 border border-slate-200 rounded-lg py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 disabled:opacity-60 transition-colors"
        >
